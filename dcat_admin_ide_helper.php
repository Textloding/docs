...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection requires_password
     ...
     * @method Grid\Column|Collection requires_password(string $label = null)
     ...
     * @method Grid\Column|Collection version_number(string $label = null)
     */
    class Grid {}
     ...
     * @property Show\Field|Collection requires_password
     ...
     * @method Show\Field|Collection requires_password(string $label = null)
     ...
     * @method Show\Field|Collection version_number(string $label = null)
     */
    class Show {}
